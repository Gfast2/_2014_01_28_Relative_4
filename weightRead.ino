...
void weightRead(int waageID){
  ...
  switch(waageID){
    ...
    case 1:    Serial3.write("$01t75\r");    break;
    case 2:    Serial3.write("$02t76\r");    break;
    case 3:    Serial3.write("$03t77\r");    break;
    case 4:    Serial3.write("$04t70\r");    break;
    default:   Serial.println("Weight Transmitter address not readable");
  }
  delay(1); //wait till the command to be totally send (in 11520 baud it should be 1 misc, 38400 c.a. 3ms)
  ...
  while(Serial3.available() > 0){
    ...
    if (Serial3.read()==38){ //'&'
      ...
      if (SignGewicht[waageID] == 32){ // "space"
        ...
        if (Serial3.read() == 't')   GewichtStatus[waageID] = 0; //if got the string end char 't'
        else{GewichtStatus[waageID] = 1; Serial.println("Read value not correct");}
      }
        ...
        if (Serial3.read() == 't') GewichtStatus[waageID] = 0;
        else{GewichtStatus[waageID] = 1; Serial.println("read value not correct");}
      }
      else{
        GewichtStatus[waageID] = 3; Serial.println("Read weight transmitter ERROR");
      }
    }
  }
  /*
