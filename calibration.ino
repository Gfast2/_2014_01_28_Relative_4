void calibration(){
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  Serial.print("... ");
  Serial2.println("#1o3000"); //Maximalfrequenz Seite50
  delay(10);
  Serial2.println("#2o3000"); //Maximalfrequenz Seite50
  delay(10);
  Serial2.println("#3o3000"); //Maximalfrequenz Seite50
  delay(10);
  Serial2.println("#4o3000"); //Maximalfrequenz Seite50
  delay(10);  
